  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
        ...
        <MetricCard label="Market Regime" value={indicators.regime} detail={indicators.adx14 ? `ADX ${indicators.adx14.toFixed(1)}` : "Calculating"} icon={Search} tone={indicators.regime.includes("Up") ? "bull" : indicators.regime.includes("Down") ? "bear" : "warn"} />
      </div>
